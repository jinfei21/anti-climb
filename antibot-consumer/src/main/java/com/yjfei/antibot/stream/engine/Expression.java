...
import com.yjfei.antibot.stream.util.Udf;
...
public class Expression implements Calculator<Object> {
    ...
    private static final JexlEngine ENGINE = new JexlBuilder()
            ...
            .silent(false)
            .strict(false)
            .namespaces(Collections.singletonMap(null, new Udf()))
            .create();
    ...
    public Object calculate(Context context) {
        ...
        try {
            ...
            log.error("exception when calculating expression: {}, context: {}",
                    this.getExpression(), context, e);
